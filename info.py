...
# Bot information
API_ID = environ.get('API_ID', '20014819')
if len(API_ID) == 0:
    logging.error('API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', 'ac8ea5efbf6a2ee0621afc563c9e59ae')
if len(API_HASH) == 0:
    logging.error('API_HASH is missing, exiting now')
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '6123215362:AAEdjf8Tj2an8mkHlYPIWGa_kxv4ElJAFbI')
if len(BOT_TOKEN) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '5928691626')
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("@FASTMOVIEDOWNLOADS") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1001743500064').split()]
...
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1001792005542')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://Fastnew:Fastnew123@cluster0.fac6d7o.mongodb.net/?retryWrites=true&w=majority")
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/fastmoviedownloads')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/fastmoviedownloads')
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1001744484589")
if len(BIN_CHANNEL) == 0:
    logging.error('BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://t.me/+vTA-gLNkm5s5ODdl")
if len(URL) == 0:
